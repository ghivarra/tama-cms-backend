...
class Admin extends Model
{
    ...
    protected $allowedFields = ['adm_nama', 'adm_password', 'adm_email', 'adm_status', 'adm_role', 'adm_foto', 'adm_token_lupa', 'adm_token_waktu', 'adm_otp', 'adm_otp_waktu', 'adm_updated_by', 'adm_created_by'];

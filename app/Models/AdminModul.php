...
class AdminModul extends Model
{
    protected $table      = 'admin_modul';
    ...
    protected $allowedFields = ['mod_nama', 'mod_status', 'mod_updated_by', 'mod_created_by'];

    protected $useTimestamps = TRUE;
    protected $createdField  = 'mod_created_at';
    protected $updatedField  = 'mod_updated_at';
    protected $deletedField  = 'mod_deleted_at';

    protected $createdByField = 'mod_created_by';
    protected $updatedByField = 'mod_updated_by';
